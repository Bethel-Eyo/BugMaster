...
public final class Insect implements Parcelable {
    ...
    public Insect(Cursor cursor) {
        ...
        this.name = cursor.getString(cursor.getColumnIndex(DatabaseManager
                .Contract.Columns.FRIENDLY_NAME));
        this.scientificName = cursor.getString(cursor.getColumnIndex(DatabaseManager
                .Contract.Columns.SCIENTIFIC_NAME));
        this.classification = cursor.getString(cursor.getColumnIndex(DatabaseManager
                .Contract.Columns.CLASSIFICATION));
        this.imageAsset = cursor.getString(cursor.getColumnIndex(DatabaseManager
                .Contract.Columns.IMAGE_ASSET));
        this.dangerLevel = cursor.getInt(cursor.getColumnIndex(DatabaseManager
